<template>
  <div>
              ...
              <li v-for="item in cartList">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascript:;" class="checkbox-btn  item-check-btn" v-bind:class="{'check':item.checked == '1'}" @click="editCheck(item)">
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        <a href="javascript:;" class="input-sub" @click="editSub(item)">-</a>
                        <span class="select-ipt">{{item.productNum}}</span>
                        <a href="javascript:;"  class="input-add" @click="editAdd(item)">+</a>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascript:;" @click="toggerCheckAll">
    ...
    <modal v-bind:mdshow="modalConfirm" v-on:close="modalConfirm = false" >
      <p slot="message">确认删除？</p>
      <div slot="btnGroup" v-bind:mdshow="modalConfirm" @close="closeModal">
        <a class="btn--m btn" href="javascript:;"@click="delCart">确认</a>
        <a class="btn--m btn" href="javascript:;"@click="modalConfirm = false">关闭</a>
      </div>
    </modal>
        ...
        delCart(){
          axios.post('/users/cartDel',{
            ...
            if (res.status == '0'){
               ...
               this.$store.commit("updateCartCount",-this.item1.productNum);
               this.init();
            }
          });
        },
