      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item ,index) in addressListFilter" v-bind:class="{'check':checkIndex == index } " @click="AddressCheck(item,index)">
                  <dl>
                    <dt>{{item.userName}}</dt>
          ...
          <div class="next-btn-wrap">
            <router-link class="btn--m btn btn--red" v-bind:to="{path:'orderConfirm',query:{'addressId':selectedAddrId || DefaultAddr}}">NEXT</router-link>
          </div>
        </div>
      </div>
    </div>
