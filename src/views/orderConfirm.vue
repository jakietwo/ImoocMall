      ...
      <div class="checkout-order">
          ...
          <div class="price-count">
            <ul>
              <li>
                ...
                <span>{{subTotalMoney| currency('￥ ')}}</span>
              </li>
              <li>
                <span>Shipping:</span>
        ...
        <div class="order-foot-wrap">
          ...
          <div class="next-btn-wrap">
            <button class="btn  btn--red" @click="PayMent">Proceed to payment</button>
          </div>
        </div>
      </div>
    </div>
      ...
      init(){
        axios.get('/users/cartList').then((response)=>{
          ...
          this.cartList.forEach((item)=>{
            if (item.checked == '1'){
              this.subTotalMoney += item.productNum* item.salePrice;
            }
          });
          this.OrderTotal = this.subTotalMoney + this.shipping - this.Discount + this.Tax;
        })
      },
      PayMent(){
